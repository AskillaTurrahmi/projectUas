<?php
	...
	if ($simpan AND $kode != "" AND $nama != "" AND $harga != ""){
		...
		$ext = end($exp);
		$path = "fotoPashmina/".$file_name;
		if (in_array($ext, $allowed_ext)) {
			if (move_uploaded_file($file_temp, $path)) {
				try {
					$koneksi->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
					$query = $koneksi->prepare("INSERT INTO pashmina (kode_barang, nama_barang, harga_barang, foto) VALUES (:kode, :nama, :harga, :file_name)");
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
		<div><h3 class="text-center">Input Data Hijab Pashmina</h3></div>
			<form action="?page=inputPashmina" method="post" enctype="multipart/form-data">
				<div class="mb-3">
